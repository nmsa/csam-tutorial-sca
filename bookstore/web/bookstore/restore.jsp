<%!    static String code = "DROP TABLE IF EXISTS card_types##"
            ...
            + ""
            + "insert into members (member_login, member_password, member_level, first_name, last_name, email)"
            + "       values ('admin', 'ho$$2010', 2, 'Administrator', 'Account', 'admin@localhost')##"
            + ""
            + "insert into members (member_login, member_password, member_level, first_name, last_name, email)"
            + "       values ('handson', 'handson', 1, 'Guest', 'Account', 'guest@localhost')##"
            + ""
            + "CREATE TABLE orders ("
            ...
            + ")##";
    static java.util.List<String> sql = new java.util.ArrayList<String>();
...
//            java.sql.Connection c = java.sql.DriverManager.getConnection("jdbc:sqlite:bookstore.db");
            java.sql.Connection c = java.sql.DriverManager.getConnection("jdbc:mysql://10.3.2.78:3306/bookstore", "bookstore", "bookstore");
...
//        }
        ...
        System.out.println("Database created successfully? 52 == " + i + "");
//    } else {
%>

<form name="keyform" action="restore.jsp" method="post">
    <input name ="key" type="password" />
    <input name ="button" type="submit" value="Restore">
</form>
