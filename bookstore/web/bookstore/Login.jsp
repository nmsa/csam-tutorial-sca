        ...
        try {
            ...
            switch (iAction) {
                case iloginAction: {
                    ...
                    rs = openrs(stat, "select member_id, member_level from members where member_password ='" + sPassword + "' and member_login='" + sLogin + "'");
    ...
    void Login_Show(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sLoginErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
        try {
            ...
            if (session.getAttribute("UserID") == null || ((String) session.getAttribute("UserID")).compareTo("") == 0) {
                // User did not login
                out.println("     <tr>\n      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Login</font></td><td style=\"background-color: #FFFFFF; border-width: 1\"><input type=\"text\" name=\"Login\" maxlength=\"200\"  value=\"" + toHTML(getParam(request, "Login")) + "\"></td>\n     </tr>");
                out.println("     <tr>\n      <td style=\"background-color: #FFEAC5; border-style: inset; border-width: 0\"><font style=\"font-size: 10pt; color: #000000\">Password</font></td><td style=\"background-color: #FFFFFF; border-width: 1\"><input type=\"password\" name=\"Password\" maxlength=\"200\" ></td>\n     </tr>");
            ...
            out.println("LoginShow");
            if (e instanceof java.sql.SQLException) {
                java.sql.SQLException se = (java.sql.SQLException) e;
                out.println("se.getSQLState()" + se.getSQLState());
            }
            bookstore.SQLHistory.logException(e, out);
        }
    }
