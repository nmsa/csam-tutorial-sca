...
<%!    String RecordAction(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sAction, String sForm, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
    ...
    void Record_Show(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sRecordErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
        try {
            ...
            out.print("<a href=\"MembersRecord.jsp?" + transitParams + "member_id=" + toURL((String) rsHash.get("member_id")) + "&\"><font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldmember_login) + "</font></a>");
            ...
            out.print("<font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldmember_level) + "&nbsp;</font>");
            out.println("</td>\n     </tr>");
            ...
            out.print("<font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldlast_name) + "&nbsp;</font>");
            out.println("</td>\n     </tr>");
            ...
            out.print("<font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldemail) + "&nbsp;</font>");
            out.println("</td>\n     </tr>");
            ...
            out.print("<font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldphone) + "&nbsp;</font>");
            out.println("</td>\n     </tr>");
            ...
            out.print("<font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldaddress) + "&nbsp;</font>");
            out.println("</td>\n     </tr>");
            ...
            out.print("<font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldnotes) + "&nbsp;</font>");
            out.println("</td>\n     </tr>");
    ...
    void Orders_Show(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sOrdersErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                out.print("<a href=\"OrdersRecord.jsp?" + transitParams + "order_id=" + toURL((String) rsHash.get("o_order_id")) + "&\"><font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldorder_id) + "</font></a>");
                ...
                out.println("</td>");
                out.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">");
                out.print("<font style=\"font-size: 10pt; color: #000000\">" + toHTML(fldquantity) + "&nbsp;</font>");
                out.println("</td>");
                out.println("     </tr>");
