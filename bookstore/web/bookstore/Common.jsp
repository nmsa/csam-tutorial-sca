...
//    static final String DBDriver = "org.sqlite.JDBC";
    ...
    static final String strConn = "jdbc:mysql://10.3.2.78:3306/bookstore?allowMultiQueries=true";
    static final String DBusername = "bookstore";
    static final String DBpassword = "bookstore";
    ...
    java.sql.ResultSet openrs(java.sql.Statement stat, String sql) throws java.sql.SQLException {
        ...
        bookstore.SQLHistory.add(sql);
        try {
            stat.execute(sql);
        } catch (java.sql.SQLException e) {
            throw new bookstore.BookstoreException(e, sql);
        }
    ...
    long dCountRec(java.sql.Statement stat, String table, String sWhere) {
        long lNumRecs = 0;
        try {
            // System.out.println("dCountRec: select count(*) from " + table + " where " + sWhere);
            bookstore.SQLHistory.add("select count(*) from " + table + " where " + sWhere);
...
//        return java.sql.DriverManager.getConnection("jdbc:sqlite:bookstore.db");
