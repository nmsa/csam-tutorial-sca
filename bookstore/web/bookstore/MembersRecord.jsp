...
<%!    String MembersAction(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sAction, String sForm, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
        ...
        try {
            ...
            bookstore.SQLHistory.logException(e, out);
        }
        return (sMembersErr);
    }
    ...
    void Members_Show(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sMembersErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
        try {
            ...
            out.print("<input type=\"text\"  name=\"member_login\" maxlength=\"200\"  value=\"" + toHTML(fldmember_login) + "\" size=\"20\">");
            ...
            out.print("<input type=\"password\"  name=\"member_password\" maxlength=\"200\"  value=\"" + toHTML(fldmember_password) + "\" size=\"20\">");
            ...
            out.print("<input type=\"text\"  name=\"name\" maxlength=\"200\"  value=\"" + toHTML(fldname) + "\" size=\"50\">");
            ...
            out.print("<input type=\"text\"  name=\"last_name\" maxlength=\"200\"  value=\"" + toHTML(fldlast_name) + "\" size=\"50\">");
            ...
            out.print("<input type=\"text\"  name=\"email\" maxlength=\"200\"  value=\"" + toHTML(fldemail) + "\" size=\"50\">");
            ...
            out.print("<input type=\"text\"  name=\"phone\" maxlength=\"200\"  value=\"" + toHTML(fldphone) + "\" size=\"50\">");
            ...
            out.print("<input type=\"text\"  name=\"address\" maxlength=\"200\"  value=\"" + toHTML(fldaddress) + "\" size=\"50\">");
            ...
            out.print("<textarea name=\"notes\" cols=\"50\" rows=\"5\">" + toHTML(fldnotes) + "</textarea>");
            ...
            out.print("<input type=\"text\"  name=\"card_number\" maxlength=\"200\"  value=\"" + toHTML(fldcard_number) + "\" size=\"50\">");
            ...
            if (bPK && !(sAction.equals("insert") && "Members".equals(sForm))) {
                out.print("<input type=\"submit\" value=\"Update\" onclick=\"document.Members.FormAction.value = 'update';\">");
                out.print("<input type=\"submit\" value=\"Delete\" onclick=\"document.Members.FormAction.value = 'delete';\">");
                out.print("<input type=\"submit\" value=\"Cancel\" onclick=\"document.Members.FormAction.value = 'cancel';\">");
                out.print("<input type=\"hidden\" name=\"FormName\" value=\"Members\"><input type=\"hidden\" value=\"update\" name=\"FormAction\">");
            } else {
                out.print("<input type=\"submit\" value=\"Insert\" onclick=\"document.Members.FormAction.value = 'insert';\">");
                out.print("<input type=\"submit\" value=\"Cancel\" onclick=\"document.Members.FormAction.value = 'cancel';\">");
