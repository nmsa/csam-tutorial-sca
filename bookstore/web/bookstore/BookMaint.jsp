...
<%!    String BookAction(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sAction, String sForm, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
    ...
    void Book_Show(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sBookErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
        try {
            ...
            out.print("<input type=\"text\"  name=\"name\" maxlength=\"100\"  value=\"" + toHTML(fldname) + "\" size=\"30\">");
            ...
            out.print("<input type=\"text\"  name=\"author\" maxlength=\"100\"  value=\"" + toHTML(fldauthor) + "\" size=\"30\">");
            ...
            out.print("<input type=\"text\"  name=\"price\" maxlength=\"100\" value=\"" + toHTML(fldprice) + "\" size=\"10\">");
            ...
            out.print("<input type=\"text\"  name=\"product_url\" maxlength=\"100\"  value=\"" + toHTML(fldproduct_url) + "\" size=\"40\">");
            ...
            out.print("<input type=\"text\"  name=\"image_url\" maxlength=\"100\"  value=\"" + toHTML(fldimage_url) + "\" size=\"40\">");
            ...
            out.print("<textarea name=\"notes\" cols=\"60\" rows=\"8\">" + toHTML(fldnotes) + "</textarea>");
            ...
            if (bPK && !(sAction.equals("insert") && "Book".equals(sForm))) {
                out.print("<input type=\"submit\" value=\"Update\" onclick=\"document.Book.FormAction.value = 'update';\">");
                out.print("<input type=\"submit\" value=\"Delete\" onclick=\"document.Book.FormAction.value = 'delete';\">");
                out.print("<input type=\"submit\" value=\"Cancel\" onclick=\"document.Book.FormAction.value = 'cancel';\">");
                out.print("<input type=\"hidden\" name=\"FormName\" value=\"Book\"><input type=\"hidden\" value=\"update\" name=\"FormAction\">");
            } else {
                out.print("<input type=\"submit\" value=\"Add\" onclick=\"document.Book.FormAction.value = 'insert';\">");
                out.print("<input type=\"submit\" value=\"Cancel\" onclick=\"document.Book.FormAction.value = 'cancel';\">");
